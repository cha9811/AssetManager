...
<body class="fade-in">
    <section id="error-space">
        <div class="image-container">
            <img src="<c:url value='/resources/CSS/img/error_img.jpg' />" alt="에러 이미지">
            ...
            <div class="text-overlay">
                ...
                <button class="custom-button" onclick="location.href='${pageContext.request.contextPath}/home';">홈으로</button>
